      ...
      <div className="rounded-3xl border border-border bg-surface p-6 shadow-sm sm:p-10">
        ...
        <div className="prose prose-sm sm:prose-base dark:prose-invert prose-p:text-secondary prose-headings:text-primary">
          <p className="lead text-lg text-secondary mb-8">
            Your privacy is important to us. It is ShopFlow's policy to respect your privacy regarding any information we may collect from you across our website and applications.
          </p>
